...
///
/// Bitácora usa **exclusivamente** la base de datos con nombre `dtbitacora`;
...
class AppFirestore {
  ...
  static const String databaseId = 'dtbitacora';

  /// Instancia de Firestore apuntando siempre a la base `dtbitacora`.
  ///
